...
void setupWiFiConf(void) {
  server.on("/wifi_conf", []() {
    ...
    content1 += F("<li><label for='ssid'>SSID : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='ssid'id='ssid' maxlength=32 value=") ;
    content1 += String(WiFiConf.sta_ssid) ;
    content1 +=  F(" ><br /><br />");

    content1 += F("<li><label for='pwd'>PASS : </label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='password' name='pwd' id='pwd' value=");
    content1 += String(WiFiConf.sta_pwd);
    content1 += F("><br /><br />");

    content1 += F("<li><label for='ip'>IP : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name='ip' id='ip'value=");
    content1 += String(WiFiConf.sta_ip) ;
    content1 +=  F(" ><br /><br />");
    
    content1 += F("<li><label for='gateway'>GATEWAY : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input  name='gateway' id='gateway' value=") ;
    content1 += String(WiFiConf.sta_gateway) ;
    content1 += F("><br /><br />");

    content1 += F("<li><label for='subnet'>SUBNET : </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input  name='subnet' id='subnet' value=");
...
server.on("/sdt_conf", []() {
    ...
    content1 += F("<li><label for='SDT1'>Phone Number 1&#09;&#09;: </label> <input  name='SDT1' id='SDT1' value=");
    content1 +=String(WiFiConf.sta_SDT1);
    content1 +=F("><br /><br />");
    content1 += F("<li><label for='SDT2'>Phone Number 2&#09;&#09;: </label> <input name='SDT2' id='SDT2'value=");
    content1 +=String(WiFiConf.sta_SDT2);
    content1 +=F("><br /><br />");
    content1 +=F("<li><label for='SDT3'>Phone Number 3&#09;&#09;: </label> <input  name='SDT3' id='SDT3' value=");
    content1 +=String(WiFiConf.sta_SDT3);
    content1 +=F("><br /><br />");
    content1 += F("<li><label for='SDT4'>Phone Number 4&#09;&#09;: </label> <input  name='SDT4' id='SDT4' value=");
  ...
  server.on("/set_sdt_conf", []() {
    ...
    String content =  F("<!DOCTYPE HTML>\r\n<html><head><link rel=\"shortcut icon\" href=\"data:image/x-icon;base64,\"/><meta charset='UTF-8'><title>");    content += WiFiConf.module_id;
  ...
  server.on("/tinnhan", []() {
    ...
    content += F("<p>");
    content += F("</p><form method='get' action='set_noidung'><li><label for='text'>Content of the message&nbsp;&nbsp;&nbsp;&nbsp;: </label><input name='text'id='text' maxlength=32  ><br /><br />");
    content += F("<li><input type='submit' value='Test' onclick='return confirm(\"Bạn muốn kiểm tra SMS ?\");'></form>");
    content += F("</body></html>");
    server.send(200, "text/html", content);
  });
  server.on("/cuocgoi", []() {
    ...
    content += F("<li><input type='submit' value='Test' onclick='return confirm(\"Bạn muốn kiểm tra CALL ?\");'></form>");
    content += F("</body></html>");
    server.send(200, "text/html", content);
  });
///////////////////////
...
//////////////
  ...
  server.on("/module_id", []() {
    ...
    content += F("</p>");
    content += F("<p>");
    content += F("<form method='get' action='set_module_id'><label for='module_id'>New Module ID: </label><input name='module_id' id='module_id' maxlength=32 value='");
    content += WiFiConf.module_id;
    content += F("'><input type='submit' onclick='return confirm(\"Are you sure you want to change the Module ID?\");'></form>");
  ...
  server.on("/Reboot", HTTP_GET, []() {
    IPAddress ip = WiFi.localIP();
    String content =  F("<!DOCTYPE HTML>\r\n<html><head><link rel=\"shortcut icon\" href=\"data:image/x-icon;base64,\"/><meta charset='UTF-8'><title>");    String ipStr = String(ip[0]) + '.' + String(ip[1]) + '.' + String(ip[2]) + '.' + String(ip[3]);
    ...
    content += F("<input type='submit' value='Reset' onclick='return confirm(\"Bạn Có Muốn Khởi Động Lại Module ?\");'></form>");
    content += F("</p>");
    content += F("</body></html>");
    server.send(200, "text/html", content);
  });
...
server.on("/mang_didong", []() {
    ...
    content += F("<li><label for='manap'>Mã Nạp:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input name='manap'id='manap' maxlength=32 value=");
    content += String(WiFiConf.sta_manap);
    content += F(" ><br /><br />");

    content +=F("<li><label for='makttk'>Mã KTTK : </label> <input  name='makttk' id='pwdhc2' value=");
   ...
   // content += F("</br>IP address: ");  
    ...
    content += F("<li><label for='manap'>USSD for Recharge code :&nbsp;</label><input name='manap'id='manap' maxlength=32 value=");
    content += String(WiFiConf.sta_manap);
    content += F(" ><br /><br />");

    content +=F("<li><label for='makttk'>USSD for Balance Check : </label> <input  name='makttk' id='pwdhc2' value=");
    content += String(WiFiConf.sta_makttk) ;
    content += F("><br /><br />");
  ...
  server.on("/hc2_conf", []() {    
    ...
    content1 += F("<li><label for='iphc2'>IP HC2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input name='iphc2'id='iphc2' maxlength=32 value=");
    content1 += String(WiFiConf.sta_iphc2);
    content1 += F(" ><br /><br />");

    content1 +=F("<li><label for='pwdhc2'>PASS HC2: </label> <input type='password' name='pwdhc2' id='pwdhc2' value=");
    content1 += String(WiFiConf.sta_passhc) ;
    content1 += F("><br /><br />");

    content1 += F("<li><label for='global1'>Global 1:&nbsp;&nbsp;&nbsp;&nbsp;</label> <input name='global1' id='global1'value=");
    content1 += String(WiFiConf.sta_global1);
    content1 += F(" ><br /><br />");

    content1 += F("<li><label for='global2'>Global 2:&nbsp;&nbsp;&nbsp;&nbsp;</label> <input  name='global2' id='global2' value=");
